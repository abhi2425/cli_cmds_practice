...
<div id='crmWebToEntityForm' class='zcwf_lblLeft crmWebToEntityForm' style='background-color: white;color: black;max-width: 600px;'>
  <meta name='viewport' content='width=device-width, initial-scale=1.0'>
   ...
   <form action='https://crm.zoho.in/crm/WebToLeadForm' name=WebToLeads377385000000254001 method='POST' onSubmit='javascript:document.charset="UTF-8"; return checkMandatory377385000000254001()' accept-charset='UTF-8'>
 <input type='text' style='display:none;' name='xnQsjsdp' value='226260fedf5402676c60581b4a97c9f5b11b8e33c4f7e04c9ceea8ca000824ce'></input> 
 <input type='hidden' name='zc_gad' id='zc_gad' value=''></input> 
 <input type='text' style='display:none;' name='xmIwtLD' value='a21c888915542d06cb6fce85e7875268f4c8e8667cfa4c5619afda4d2632d7fb'></input> 
 <input type='text'  style='display:none;' name='actionType' value='TGVhZHM='></input>
 <input type='text' style='display:none;' name='returnURL' value='https&#x3a;&#x2f;&#x2f;dev.dvio.global&#x2f;chat-bot&#x2f;meydan&#x2f;' > </input>
...
<div class='zcwf_title' style='max-width: 600px;color: black;'>Chat Bot Form</div>
...
<div class='zcwf_row'><div class='zcwf_col_lab' style='font-size:12px; font-family: Arial;'><label for='Mobile'>Mobile<span style='color:red;'>*</span></label></div><div class='zcwf_col_fld'><input type='text' id='Mobile' name='Mobile' maxlength='30'></input><div class='zcwf_col_help'></div></div></div><div class='zcwf_row'><div class='zcwf_col_lab'></div><div class='zcwf_col_fld'><input type='submit' id='formsubmit' class='formsubmit zcwf_button' value='Submit' title='Submit'><input type='reset' class='zcwf_button' name='reset' value='Reset' title='Reset'></div></div>
	<script>
	function validateEmail377385000000254001()
	{
		var form = document.forms['WebToLeads377385000000254001'];
 	  ...
 	  function checkMandatory377385000000254001() {
		var mndFileds = new Array('Last Name','Email','Mobile');
		var fldLangVal = new Array('Name','Email','Mobile');
		for(i=0;i<mndFileds.length;i++) {
		  var fieldObj=document.forms['WebToLeads377385000000254001'][mndFileds[i]];
		  if(fieldObj) {
		...
		if(!validateEmail377385000000254001()){return false;}
		document.querySelector('.crmWebToEntityForm .formsubmit').setAttribute('disabled', true);
	}

function tooltipShow377385000000254001(el){
